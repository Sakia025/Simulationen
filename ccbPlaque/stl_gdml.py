...
MATERIALS_LIST = [
  ...
  {"name" : "H2O",           "group" : "Eyematerials"},
  {"name" : "bicarbonate",   "group" : "Eyematerials"},
  {"name" : "lactate",       "group" : "Eyematerials"},
  {"name" : "glucose",       "group" : "Eyematerials"},
  {"name" : "ascorbate",     "group" : "Eyematerials"},
  {"name" : "phosphate",     "group" : "Eyematerials"},
  {"name" : "citrate",       "group" : "Eyematerials"},
  {"name" : "alanine",       "group" : "Eyematerials"},
  {"name" : "leucine",       "group" : "Eyematerials"},
  {"name" : "lysine",        "group" : "Eyematerials"},
  {"name" : "threonine",     "group" : "Eyematerials"},
  {"name" : "valine",        "group" : "Eyematerials"},
  {"name" : "collagen",      "group" : "Eyematerials"},
  {"name" : "elastin",       "group" : "Eyematerials"},
  {"name" : "pyruvicacid",   "group" : "Eyematerials"},
  {"name" : "arginine",      "group" : "Eyematerials"},
  {"name" : "asparticacid",  "group" : "Eyematerials"},
  {"name" : "cysteine",      "group" : "Eyematerials"},
  {"name" : "glutamicacid",  "group" : "Eyematerials"},
  {"name" : "glycine",       "group" : "Eyematerials"},
  {"name" : "histidine",     "group" : "Eyematerials"},
  {"name" : "hydroxylysine", "group" : "Eyematerials"},
  {"name" : "hydroxyproline","group" : "Eyematerials"},
  {"name" : "isoleucine",    "group" : "Eyematerials"},
  {"name" : "methionine",    "group" : "Eyematerials"},
  {"name" : "phenylalanine", "group" : "Eyematerials"},
  {"name" : "proline",       "group" : "Eyematerials"},
  {"name" : "serine",        "group" : "Eyematerials"},
  {"name" : "tyrosine",      "group" : "Eyematerials"},
  {"name" : "blood",         "group" : "Eyematerials"},
  {"name" : "bonecranium",   "group" : "Eyematerials"},
  {"name" : "eyelens",       "group" : "Eyematerials"},
  {"name" : "eyenerve",      "group" : "Eyematerials"},
  {"name" : "muscle",        "group" : "Eyematerials"},
  {"name" : "skin",          "group" : "Eyematerials"},
  {"name" : "aqueoushumor",  "group" : "Eyematerials"},
  {"name" : "cornea",        "group" : "Eyematerials"},
  {"name" : "sclera",        "group" : "Eyematerials"},
  {"name" : "tumor",         "group" : "Eyematerials"},
  {"name" : "vitreoushumor", "group" : "Eyematerials"},
  {"name" : "choroidea",     "group" : "Eyematerials"},
  {"name" : "netzhaut",      "group" : "Eyematerials"},
  {"name" : "ruthenium",      "group" : "Eyematerials"},
]
...
MATERIALS = '''
	...
	<!-- composite elements -->
        ...
        <isotope name="Cl35"  N="18" Z="17">   <atom unit="g/mole" value="34.96885269"/>  </isotope>
        <isotope name="Cl37"  N="20" Z="17">   <atom unit="g/mole" value="36.96590258"/>  </isotope>
        <element name="chlorine">
            <!-- see: https://en.wikipedia.org/wiki/Isotopes_of_chlorine -->
            <fraction n="0.76" ref="Cl35"/>
            <fraction n="0.24" ref="Cl37"/>
        </element>
        ...
        <isotope name="Ru106"  N="62" Z="44">   <atom unit="g/mole" value="105.907329"/>  </isotope>
        <element name="Ru">
                <fraction ref="Ru106" n="1.0"/>
        </element>
	...
	<!-- materials -->
        ...
        <material name="H2O" formula="H2O">
            <D value="0.998" unit="g/cm3"/>
            <composite n="2" ref="hydrogen"/>
            <composite n="1" ref="oxygen"/>
        </material>

          <material name="bicarbonate" formula="HCO3">
            <D value="1.67" unit="g/cm3"/>
            <composite n="1" ref="hydrogen"/>
            <composite n="3" ref="oxygen"/>
            <composite n="1" ref="carbon"/>
        </material>

         <material name="lactate" formula="C3H5O3">
            <D value="1.209" unit="g/cm3"/>
            <composite n="5" ref="hydrogen"/>
            <composite n="3" ref="oxygen"/>
            <composite n="3" ref="carbon"/>
        </material>

          <material name="glucose" formula="C6H12O6">
            <D value="1.54" unit="g/cm3"/>
            <composite n="12" ref="hydrogen"/>
            <composite n="6" ref="oxygen"/>
            <composite n="6" ref="carbon"/>
        </material>

           <material name="ascorbate" formula="C6H7O6">
            <D value="1.65" unit="g/cm3"/>
            <composite n="7" ref="hydrogen"/>
            <composite n="6" ref="oxygen"/>
            <composite n="6" ref="carbon"/>
        </material>

           <material name="phosphate" formula="PO4">
            <D value="1.87" unit="g/cm3"/>
            <composite n="4" ref="oxygen"/>
            <composite n="1" ref="phosphorus"/>
        </material>

           <material name="citrate" formula="C6H5O7">
            <D value="1.665" unit="g/cm3"/>
            <composite n="5" ref="hydrogen"/>
            <composite n="7" ref="oxygen"/>
            <composite n="6" ref="carbon"/>
        </material>

         <material name="alanine" formula="C3H7NO2">
            <D value="1.432" unit="g/cm3"/>
            <composite n="7" ref="hydrogen"/>
           ...
           <material name="leucine" formula="C6H13NO2">
            <D value="1.293" unit="g/cm3"/>
            <composite n="13" ref="hydrogen"/>
            <composite n="2" ref="oxygen"/>
            <composite n="6" ref="carbon"/>
            <composite n="1" ref="nitrogen"/>
        </material>

          <material name="lysine" formula="C6H14N2O2">
            <D value="1.1" unit="g/cm3"/>
            <composite n="14" ref="hydrogen"/>
            <composite n="2" ref="oxygen"/>
            <composite n="6" ref="carbon"/>
            <composite n="2" ref="nitrogen"/>
        </material>

           <material name="threonine" formula="C4H9NO3">
           ...
           <material name="valine" formula="C5H11NO2">
           ...
           <material name="pyruvicacid" formula="C3H4O3">
           ...
           <material name="arginine" formula="C6H14N4O2">
           ...
           <material name="asparticacid" formula="C4H7NO4">
            <D value="1.66" unit="g/cm3"/>
            <composite n="4" ref="carbon"/>
            <composite n="7" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
            <composite n="4" ref="oxygen"/>
           ...
           <material name="cysteine" formula="C3H7NO2S">
            <D value="1.3" unit="g/cm3"/>
            <composite n="3" ref="carbon"/>
            <composite n="7" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
           ...
           <material name="glutamicacid" formula="C5H9NO4">
            <D value="1.525" unit="g/cm3"/>
            <composite n="5" ref="carbon"/>
            <composite n="9" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
            <composite n="4" ref="oxygen"/>
           ...
           <material name="glycine" formula="C2H5NO2">
            <D value="1.595" unit="g/cm3"/>
          ...
          <material name="histidine" formula="C6H9N3O2">
           ...
           <material name="hydroxylysine" formula="C6H14N2O3">
            <D value="1.3" unit="g/cm3"/>
            <composite n="6" ref="carbon"/>
            <composite n="14" ref="hydrogen"/>
            <composite n="2" ref="nitrogen"/>
           ...
           <material name="hydroxyproline" formula="C5H9NO3">
            <D value="1.4" unit="g/cm3"/>
            <composite n="5" ref="carbon"/>
            <composite n="9" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
           ...
           <material name="isoleucine" formula="C6H13NO2">
            <D value="1.4" unit="g/cm3"/>
            <composite n="6" ref="carbon"/>
            <composite n="13" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
           ...
           <material name="methionine" formula="C5H11NO2S">
           ...
           <material name="phenylalanine" formula="C9H11NO2">
           ...
           <material name="proline" formula="C5H9NO2">
           ...
           <material name="serine" formula="C3H7NO3">
            <D value="1.537" unit="g/cm3"/>
            <composite n="3" ref="carbon"/>
            <composite n="7" ref="hydrogen"/>
            <composite n="1" ref="nitrogen"/>
            <composite n="3" ref="oxygen"/>
           ...
           <material name="tyrosine" formula="C9H11NO3">
          ...
          <material name="collagen">  
           <D value="1.343" unit="g/cm3"/>
           <fraction n="0.096" ref="alanine"/>
           <fraction n="0.046" ref="arginine"/>
           <fraction n="0.042" ref="asparticacid"/>
           <fraction n="0.002" ref="cysteine"/>
           <fraction n="0.071" ref="glutamicacid"/>
           <fraction n="0.350" ref="glycine"/>
           <fraction n="0.006" ref="histidine"/>
           <fraction n="0.005" ref="hydroxylysine"/>
           <fraction n="0.125" ref="hydroxyproline"/>
           <fraction n="0.013" ref="isoleucine"/>
           <fraction n="0.022" ref="leucine"/>
           <fraction n="0.030" ref="lysine"/>
           <fraction n="0.008" ref="methionine"/>
           <fraction n="0.008" ref="phenylalanine"/>
           <fraction n="0.107" ref="proline"/>
           <fraction n="0.039" ref="serine"/>
           <fraction n="0.013" ref="threonine"/>
           <fraction n="0.003" ref="tyrosine"/>
           <fraction n="0.014" ref="valine"/>
     </material>

          <material name="elastin">  
           <D value="1.3" unit="g/cm3"/>
           <fraction n="0.17915" ref="alanine"/>
           <fraction n="0.00506" ref="arginine"/>
           <fraction n="0.00405" ref="asparticacid"/>
           <fraction n="0.01316" ref="glutamicacid"/>
           <fraction n="0.36538" ref="glycine"/>
           <fraction n="0.00101" ref="histidine"/>
           <fraction n="0.01923" ref="hydroxyproline"/>
           <fraction n="0.01923" ref="isoleucine"/>
           <fraction n="0.05061" ref="leucine"/>
           <fraction n="0.00304" ref="lysine"/>
           <fraction n="0.02024" ref="phenylalanine"/>
           <fraction n="0.12854" ref="proline"/>
           <fraction n="0.00506" ref="serine"/>
           <fraction n="0.00709" ref="threonine"/>
           <fraction n="0.01113" ref="tyrosine"/>
           <fraction n="0.16802" ref="valine"/>
     </material>

          <material name="blood">  
           <D value="1.06" unit="g/cm3"/>
           <fraction n="0.102" ref="hydrogen"/>
           <fraction n="0.110" ref="carbon"/>
           <fraction n="0.033" ref="nitrogen"/>
           <fraction n="0.745" ref="oxygen"/>
           <fraction n="0.002" ref="sulphur"/>
           <fraction n="0.001" ref="sodium"/>
           <fraction n="0.003" ref="chlorine"/>
           <fraction n="0.001" ref="phosphorus"/>
           <fraction n="0.002" ref="potassium"/>
           <fraction n="0.001" ref="iron"/>
     </material>

          <material name="bonecranium">  
           <D value="1.61" unit="g/cm3"/>
           <fraction n="0.050" ref="hydrogen"/>
           <fraction n="0.212" ref="carbon"/>
           <fraction n="0.040" ref="nitrogen"/>
           <fraction n="0.435" ref="oxygen"/>
           <fraction n="0.003" ref="sulphur"/>
           <fraction n="0.001" ref="sodium"/>
           <fraction n="0.081" ref="phosphorus"/>
           <fraction n="0.002" ref="magnesium"/>
           <fraction n="0.176" ref="calcium"/>
     </material>

          <material name="eyelens">  
           <D value="1.07" unit="g/cm3"/>
           <fraction n="0.096" ref="hydrogen"/>
           <fraction n="0.195" ref="carbon"/>
           <fraction n="0.057" ref="nitrogen"/>
           <fraction n="0.646" ref="oxygen"/>
           <fraction n="0.003" ref="sulphur"/>
           <fraction n="0.001" ref="sodium"/>
           <fraction n="0.001" ref="chlorine"/>
           <fraction n="0.001" ref="phosphorus"/>
     </material>

          <material name="eyenerve">  
           <D value="1.04" unit="g/cm3"/>
           <fraction n="0.107" ref="hydrogen"/>
           <fraction n="0.145" ref="carbon"/>
           <fraction n="0.022" ref="nitrogen"/>
           <fraction n="0.712" ref="oxygen"/>
           <fraction n="0.002" ref="sulphur"/>
           <fraction n="0.002" ref="sodium"/>
           <fraction n="0.003" ref="chlorine"/>
           <fraction n="0.004" ref="phosphorus"/>
           <fraction n="0.003" ref="potassium"/>
     </material>

          <material name="muscle">  
           <D value="1.05" unit="g/cm3"/>
           <fraction n="0.102" ref="hydrogen"/>
           <fraction n="0.143" ref="carbon"/>
           <fraction n="0.034" ref="nitrogen"/>
           <fraction n="0.710" ref="oxygen"/>
           <fraction n="0.003" ref="sulphur"/>
           <fraction n="0.001" ref="sodium"/>
           <fraction n="0.001" ref="chlorine"/>
           <fraction n="0.002" ref="phosphorus"/>
           <fraction n="0.004" ref="potassium"/>
     </material>

          <material name="skin">  
           <D value="1.09" unit="g/cm3"/>
           <fraction n="0.100" ref="hydrogen"/>
           <fraction n="0.204" ref="carbon"/>
           <fraction n="0.042" ref="nitrogen"/>
           <fraction n="0.645" ref="oxygen"/>
           <fraction n="0.002" ref="sulphur"/>
           <fraction n="0.002" ref="sodium"/>
           <fraction n="0.003" ref="chlorine"/>
           <fraction n="0.001" ref="phosphorus"/>
           <fraction n="0.001" ref="potassium"/>
     </material>

          <material name="aqueoushumor">  
           <D value="1.00" unit="g/cm3"/>
           <fraction n="0.98687" ref="H2O"/>
           <fraction n="0.00619" ref="sodium"/>
           <fraction n="0.00541" ref="chlorine"/>
           <fraction n="0.00085" ref="bicarbonate"/>
           <fraction n="0.00015" ref="lactate"/>
           <fraction n="0.00014" ref="glucose"/>
           <fraction n="0.00013" ref="potassium"/>
           <fraction n="0.00008" ref="calcium"/>
           <fraction n="0.00005" ref="magnesium"/>
           <fraction n="0.00004" ref="ascorbate"/>
           <fraction n="0.00003" ref="phosphate"/>
           <fraction n="0.00001" ref="citrate"/>
           <fraction n="0.00001" ref="alanine"/>
           <fraction n="0.00001" ref="leucine"/>
           <fraction n="0.00001" ref="lysine"/>
           <fraction n="0.00001" ref="threonine"/>
           <fraction n="0.00001" ref="valine"/>
     </material>

          <material name="cornea">  
           <D value="1.024" unit="g/cm3"/>
           <fraction n="0.78000" ref="H2O"/>
           <fraction n="0.15000" ref="collagen"/>
           <fraction n="0.01977" ref="chlorine"/>
           <fraction n="0.01725" ref="sodium"/>
           <fraction n="0.00985" ref="oxygen"/>
           <fraction n="0.00719" ref="potassium"/>
           <fraction n="0.00660" ref="carbon"/>
           <fraction n="0.00659" ref="sulphur"/>
           <fraction n="0.00090" ref="hydrogen"/>
           <fraction n="0.00055" ref="nitrogen"/>
           <fraction n="0.00076" ref="phosphorus"/>
           <fraction n="0.00030" ref="calcium"/>
           <fraction n="0.00024" ref="magnesium"/>
     </material>

          <material name="sclera">  
           <D value="1.049" unit="g/cm3"/>
           <fraction n="0.68000" ref="H2O"/>
           <fraction n="0.27000" ref="collagen"/>
           <fraction n="0.01000" ref="elastin"/>
           <fraction n="0.00985" ref="oxygen"/>
           <fraction n="0.00920" ref="chlorine"/>
           <fraction n="0.00660" ref="carbon"/>
           <fraction n="0.00583" ref="sodium"/>
           <fraction n="0.00333" ref="sulphur"/>
           <fraction n="0.00297" ref="potassium"/>
           <fraction n="0.00090" ref="hydrogen"/>
           <fraction n="0.00055" ref="nitrogen"/>
           <fraction n="0.00043" ref="phosphorus"/>
           <fraction n="0.00027" ref="calcium"/>
           <fraction n="0.00007" ref="magnesium"/>
     </material>

          <material name="tumor">  
           <D value="1.049" unit="g/cm3"/>
           <fraction n="0.61500" ref="oxygen"/>
           <fraction n="0.21200" ref="chlorine"/>
           <fraction n="0.09400" ref="hydrogen"/>
           <fraction n="0.05600" ref="nitrogen"/>
           <fraction n="0.00644" ref="sulphur"/>
           <fraction n="0.00506" ref="potassium"/>
           <fraction n="0.00506" ref="phosphorus"/>
           <fraction n="0.00391" ref="chlorine"/>
           <fraction n="0.00253" ref="sodium"/>
     </material>

          <material name="vitreoushumor">  
           <D value="1.0065" unit="g/cm3"/>
           <fraction n="0.99064" ref="H2O"/>
           <fraction n="0.00431" ref="chlorine"/>
           <fraction n="0.00337" ref="sodium"/>
           <fraction n="0.00054" ref="glucose"/>
           <fraction n="0.00040" ref="collagen"/>
           <fraction n="0.00036" ref="lactate"/>
           <fraction n="0.00022" ref="potassium"/>
           <fraction n="0.00007" ref="calcium"/>
           <fraction n="0.00007" ref="pyruvicacid"/>
           <fraction n="0.00002" ref="magnesium"/>
     </material>

          <material name="choroidea">  
           <D value="1.002" unit="g/cm3"/>
           <fraction n="0.68000" ref="H2O"/>
           <fraction n="0.27000" ref="collagen"/>
           <fraction n="0.01000" ref="elastin"/>
           <fraction n="0.00985" ref="oxygen"/>
          ...
          <material name="netzhaut">  
           <D value="1.008" unit="g/cm3"/>
           <fraction n="0.99064" ref="H2O"/>
           <fraction n="0.00431" ref="chlorine"/>
           <fraction n="0.00337" ref="sodium"/>
           <fraction n="0.00054" ref="glucose"/>
           ...
           <material name="ruthenium" state="solid">
           <D value="12.36" unit="g/cm3"/>
           <fraction n="1." ref="Ru"/>
      </material>
